from rest_framework import viewsets, generics, status, filters, serializers as drf_serializers
...
from .models import Movie, Genre, Hall, Seat, Session, Booking, HallType, User
...
from .services.user_service import register_user, RegistrationError
