...
| :--- | :--- | :--- |
| **Аналітик / Архітектор** | **Матвійчук Роман** | Проектування БД, API контракти, нагляд за архітектурою. |
| **Backend Розробник** | **Тарас Шило** | Django REST Framework, Auth, логіка сеансів та бронювань. |
| **Frontend Розробник** | **Вакулюк Павло** | React компоненти, Router, інтерактивна схема залу, UX/UI. |
| **Тестувальник (QA)** | **Команда** | Unit та інтеграційне тестування перед деплоєм. |

### Етапи розробки:
1.  **Спринт 1:** Setup проєкту, БД та Auth (Django + JWT).
2.  **Спринт 2:** API для фільмів та розкладу. Базовий Frontend (List/Detail).
3.  **Спринт 3:** Схема залу та логіка бронювання.
4.  **Спринт 4:** Особистий кабінет, адмін-панель та фінальне тестування.