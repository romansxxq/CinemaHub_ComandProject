...
## 1. Мета проєкту
Створення комплексного вебзастосунку для автоматизації процесу бронювання квитків у кінотеатрі. Основна мета - забезпечити безшовну взаємодію користувача з розкладом сеансів, вибором місць та керуванням замовленнями, а також надати-адміністраторам інструменти для управління контентом.
